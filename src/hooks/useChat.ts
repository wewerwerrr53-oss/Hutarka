...
export const useChat = ({ messages: initialMessages, onMessagesUpdate }: UseChatProps) => {
  ...
  // 🔑 Инициализация аутентификации  https://hutarka.pro/auth/init https://testdeploysalesmanai3.onrender.com https://testdeploysalesmanai3.onrender.com/auth/init  http://127.0.0.1:5000
  useEffect(() => {
